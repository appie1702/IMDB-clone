...
const page = () => {
  return (
    <div className="max-w-4xl mx-auto space-y-5 p-4 mt-5">
      <h1 className='text-5xl font-medium text-[#f4230c]'>About</h1>
      <p>
        Welcome to my movie database website! I am passionate movie
        enthusiast and I have created a one-stop destination for
